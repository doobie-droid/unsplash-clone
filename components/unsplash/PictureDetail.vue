<template>
  <div id="picture-details" class="overlay">
    ...
    <button aria-controls="picture-details" role="button" title="Close overlay" @click="closeModal">
      <svg fill="#ffffff" width="32px" height="32px" viewBox="0 0 256.00 256.00" id="Flat"
        xmlns="http://www.w3.org/2000/svg" stroke="#fff" stroke-width="25.6">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#000" stroke-width="25.6">
          <path
